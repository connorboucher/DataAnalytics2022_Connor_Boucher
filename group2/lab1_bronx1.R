...
library("xlsx")
bronx1<-read.xlsx("C:/Users/bouchc2/Downloads/Data Analytics/group2/rollingsales_bronx.xls",pattern="BOROUGH",stringsAsFactors=FALSE,sheetIndex=1,startRow=5,header=TRUE)
View(bronx1)
#
...
LAND.SQUARE.FEET[LAND.SQUARE.FEET==0] <- NA
